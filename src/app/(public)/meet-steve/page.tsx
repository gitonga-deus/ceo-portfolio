...
import { Building2, Users, TrendingUp, Award, ArrowRight, Mail, ExternalLink } from "lucide-react"
			...
			<section className="py-20 px-4 bg-white">
				<div className="container max-w-4xl mx-auto text-center">
					...
					>
						...
						<p className="text-lg text-muted-foreground mb-8 max-w-4xl text-balance mx-auto">
							Whether you're interested in collaboration, investment opportunities, or just want to chat about business, I'd love to connect.
						</p>
						<motion.div
							initial={{ opacity: 0, y: 20 }}
							whileInView={{ opacity: 1, y: 0 }}
