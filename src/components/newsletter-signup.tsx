...
export function NewsletterSignup() {
				...
				<div className="max-w-6xl mx-auto px-4">
					<div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8 lg:flex-row lg:justify-between">
						<div className="mb-4 p-4">
							<h2 className="text-center text-xl font-bold text-[#1285e4] sm:text-2xl lg:text-3xl mb-4">Thank you!</h2>
	...
	return (
		<div className="bg-muted/50 py-6 sm:py-8 lg:py-12 rounded-lg">
			<div className="max-w-6xl mx-auto px-4">
				<div className="flex flex-col items-center p-4 sm:p-8">
					<div className="mb-4 sm:mb-8">
						<h2 className="text-center text-xl font-bold text-[#1285e4] sm:text-2xl lg:text-3xl py-6">Stay Updated</h2>
					...
					<form onSubmit={handleSubmit} className="mb-3 flex w-full max-w-md gap-2 sm:mb-5">
						<Input
							...
							required
							className="bg-gray-white w-full flex-1 rounded-md border border-gray-300 h-10 px-3 py-2 text-gray-800 placeholder-gray-400 transition duration-100 focus:ring"
						/>

						<Button
							type="submit"
							disabled={isLoading}
							className="inline-block rounded-md bg-[#1285e4] px-8 text-center text-sm font-semibold text-white outline-none h-10 ring-indigo-300 transition duration-100 hover:bg-[#1285e4]/90 focus-visible:ring md:text-base"
						>
